...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/file/aeba6ea2125aa7774b1b5.jpg"

# Default .helpme Logo
INLINE_PIC = os.environ.get(
    "INLINE_PIC") or "https://telegra.ph/file/aeba6ea2125aa7774b1b5.jpg"
...
async def checking():
    gccok = str(pybase64.b64decode("QGhpcm9zaGlzdXBwb3J0"))[2:17]
    chcok = str(pybase64.b64decode("QGhpcm9zaGltYWJlcw=="))[2:15]
    try:
    ...
    if len(pairs) > number_of_rows:
        pairs = pairs[
            ...
            (
                ...
                custom.Button.inline("🗑 Close", b"close"),
                custom.Button.inline(
...
with bot:
    try:
        ...
        async def inline_handler(event):
            ...
            result = None
            query = event.text
            if event.query.user_id == uid and query.startswith("@HiroshiUserbot"):
